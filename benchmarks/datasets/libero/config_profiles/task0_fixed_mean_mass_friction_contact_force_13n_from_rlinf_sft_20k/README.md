# Task 0 fixed-mean physics with a target-contact 13 N squeeze override
...
- After the first object-filtered finger contact of at least `0.1 N`, the controller latches a `13 N` normal-force target per finger (`26 N` in Tabero's two-finger squeeze convention).
